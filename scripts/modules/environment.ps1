...
function Test-EnvironmentRequirements {
    ...
    if ($isAdmin) {
        ...
        if ($RequireAdmin) {
            Write-Error "Este modo requer privilegios de administrador"
            ...
            Write-Warning "Nao executando como Administrador"
            Write-Info "Modo Service requer admin. Modo Process disponivel sem admin."
        }
    }
